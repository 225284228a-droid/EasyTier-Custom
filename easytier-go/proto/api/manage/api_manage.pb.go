...
type NetworkConfig struct {
	...
	Sni                            *string                    `protobuf:"bytes,73,opt,name=sni,proto3,oneof" json:"sni,omitempty"`
	...
	P2PPreferProtocol *string `protobuf:"bytes,78,opt,name=p2p_prefer_protocol,json=p2pPreferProtocol,proto3,oneof" json:"p2p_prefer_protocol,omitempty"`
	...
	// Manually configured peers and inbound connections are kept.
	CloseRedundantConnsWhenDisguised *bool `protobuf:"varint,79,opt,name=close_redundant_conns_when_disguised,json=closeRedundantConnsWhenDisguised,proto3,oneof" json:"close_redundant_conns_when_disguised,omitempty"`
...
func (x *NetworkConfig) GetSni() string {
	if x != nil && x.Sni != nil {
		return *x.Sni
	}
	return ""
...
func (x *NetworkConfig) GetOnlyUseWssHttp3ForHolePunching() bool {
	if x != nil && x.OnlyUseWssHttp3ForHolePunching != nil {
		return *x.OnlyUseWssHttp3ForHolePunching
	}
	return false
}

func (x *NetworkConfig) GetPreferWssHttp3ForP2P() bool {
	if x != nil && x.PreferWssHttp3ForP2P != nil {
		return *x.PreferWssHttp3ForP2P
	}
	return false
}
...
func (x *NetworkConfig) GetP2PPreferProtocol() string {
	if x != nil && x.P2PPreferProtocol != nil {
		return *x.P2PPreferProtocol
	}
	return ""
}

func (x *NetworkConfig) GetCloseRedundantConnsWhenDisguised() bool {
	if x != nil && x.CloseRedundantConnsWhenDisguised != nil {
		return *x.CloseRedundantConnsWhenDisguised
	}
	return false
}
...
func (x *ListNetworkInstanceResponse) GetDisabledInstIds() []*common.UUID {
	if x != nil {
		return x.DisabledInstIds
	}
	return nil
}
...
type SaveNetworkInstanceConfigRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstId        *common.UUID           `protobuf:"bytes,1,opt,name=inst_id,json=instId,proto3" json:"inst_id,omitempty"`
	Config        *NetworkConfig         `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"`
	Source        ConfigSource           `protobuf:"varint,3,opt,name=source,proto3,enum=api.manage.ConfigSource" json:"source,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SaveNetworkInstanceConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SaveNetworkInstanceConfigRequest) GetConfig() *NetworkConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *SaveNetworkInstanceConfigRequest) GetSource() ConfigSource {
	if x != nil {
		return x.Source
	}
	return ConfigSource_ConfigSourceUnspecified
...
type SaveNetworkInstanceConfigResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SaveNetworkInstanceConfigResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SetNetworkInstanceEnabledRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SetNetworkInstanceEnabledRequest) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *SetNetworkInstanceEnabledResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RemoveNetworkInstanceConfigRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RemoveNetworkInstanceConfigResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_api_manage_proto_rawDesc = "" +
	...
	"\x11prefer_peer_relay\x18H \x01(\bH9R\x0fpreferPeerRelay\x88\x01\x01\x12\x15\n" +
	...
	"\x05metas\x18\x01 \x03(\v2\x17.api.manage.NetworkMetaR\x05metas\"\xae\x01\n" +
	" SaveNetworkInstanceConfigRequest\x12%\n" +
	"\ainst_id\x18\x01 \x01(\v2\f.common.UUIDR\x06instId\x121\n" +
	...
	"\x17ListNetworkInstanceMeta\x12*.api.manage.ListNetworkInstanceMetaRequest\x1a+.api.manage.ListNetworkInstanceMetaResponse\"\x00\x12z\n" +
	"\x19SaveNetworkInstanceConfig\x12,.api.manage.SaveNetworkInstanceConfigRequest\x1a-.api.manage.SaveNetworkInstanceConfigResponse\"\x00\x12z\n" +
	"\x19SetNetworkInstanceEnabled\x12,.api.manage.SetNetworkInstanceEnabledRequest\x1a-.api.manage.SetNetworkInstanceEnabledResponse\"\x00\x12\x80\x01\n" +
	"\x1bRemoveNetworkInstanceConfig\x12..api.manage.RemoveNetworkInstanceConfigRequest\x1a/.api.manage.RemoveNetworkInstanceConfigResponse\"\x00b\x06proto3"
